...
6. Commit and push changes
    ...
    git commit -m 'publish: Version 4.0 of EML-BP published'
    git push

7. On GitHub, prepare and publish a release for the new document in the `releases-guide-eml-bp` branch. Once this 

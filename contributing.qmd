...
5. ***If this is a new branch,*** **remove any files that will not be published**, and rename the `_bookquarto.yml` file. 
...
6. **Commit, tag and push changes to GitHub**
...
7. **On GitHub, prepare and publish a release using the tag above**, which will include all new and updated documents in the `releases-guide-eml-bp` branch.

8. **Check Zenodo to make sure the release has been published and issued a DOI.** Be sure to check and edit authors for the publication. They are generally rendered from the GitHub repository contributors, not the documents themselves. You can contribute to any Zenodo communities (like EDI) from the Zenodo landing page as well.

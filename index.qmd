...
Most content here is from the most recent "official" update of the guides that happened around May of 2022. Newer, community-led content is available for review in the [prerelease version](https://prerelease-edi-docs.netlify.app).
...
- Minimize heterogeneity of EML-described data packages to simplify development and reuse of software
...
To contribute to these documents or participate in the associated working groups, see the "[About this site](about.qmd)" page or the [repository README](https://github.com/EDIorg/data-package-best-practices). This website and all documents are rendered as a [Quarto book](https://quarto.org/docs/books).

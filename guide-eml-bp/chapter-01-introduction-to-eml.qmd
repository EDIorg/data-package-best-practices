...
Numbered examples of XML elements and schema-valid EML are used throughout this guide and have captions numbering them sequentially within chapters. All example XML snippets are presented in a fixed-width font with syntax highlighting and a colored background box, as in Example 1.1. Any chapters describing EML elements and their use will have a highlighted section at the bottom of the chapter listing the “XPaths referenced in this chapter”.  More extensive details and definitions for XML markup language (tags, elements, etc.) and `XPath` expressions are given in [Appendix B](appendix-b-xml-schemas-and-eml.qmd).

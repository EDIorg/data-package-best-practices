...
_Context note: Communities sometimes have specific requests for keywords to
...
_Context note: If no_ <**intellectualRights**> _element is included EDI
...
_Context note: The EDI repository will ignore a `<distribution>` element
...
_Context note: for am EML data package to be accepted into the EDI
...
_Context note: The EDI repository system has alternatives for uploading data
...
<**funding**> and <**studyAreaDiscription**>.

<**funding**> should contain the agency and grant number. It is
not optional.
...
_Context note: The EDI repository requires that <**entityName**>s be unique
within the data package (EML document)._
...
_Context note: in the EDI repository,_ <**attributeName**>_s must be unique
...
_Context note: EDI has adopted the LTER Unit Registry and recommends that
...
detail in **methods/methodStep**. Together, the information in
...
more fully, as "YYYY-MM-DDThh:mm:ssTZ" (eg 1997-07-16T19:20:30.45Z).

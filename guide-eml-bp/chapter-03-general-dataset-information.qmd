...
*Context note: When submitting to the EDI repository, the &lt;**pubDate**> element for the dataset is automatically populated with the date the dataset is published and receives a DOI.*
...
*Context note: When submitting to the EDI repository, an &lt;**alternateIdentifier**> element will be added to EML containing the DOI that the dataset is published under.*

...
*Context note: The EDI repository still recommends including the &lt;**access**> element as the first child of the root (**&lt;eml:eml>**) element and uses an [access control format](https://edirepository.org/resources/access-control) that conforms to the KNB system of using the LDAP “distinguishedName (dn)” for an individual, as in “uid=userID,o=EDI,dc=edirepository,dc=org.” Public access is recommended, but a [temporary embargo on the data entities](https://edirepository.org/about/edi-policy) may be requested with certain exceptions.*
...
*Context note: Recommendations for handling [large datasets in EDI](https://ediorg.github.io/data-package-best-practices/large-data-sets.html). Contact [EDI support](mailto:support@edirepository.org).*
...
*Context note: In-depth discussion of licensing data may be found at [EDI](https://edirepository.org/resources/licensing-data), the [LTER Network Data Access Policy](https://lternet.edu/data-access-policy/#:~:text=LTER%20data%20and%20metadata%20may,credited%20for%20the%20original%20creation.), and the respective recommended public licenses ([open access with attribution](https://spdx.org/licenses/CC-BY-4.0.html), [data in public domain](https://spdx.org/licenses/CC0-1.0.html)).*

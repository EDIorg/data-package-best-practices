...
*Context note: The* &lt;**dataSource**> *element is used by the EDI repository’s provenance tracking system for linking between derived and source data packages. For more information, see additional data [repository resources from EDI.](https://edirepository.org/resources/provenance-metadata)*

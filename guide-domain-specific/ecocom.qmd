---
title: Ecological community survey data (ecocomDP)
date: last-modified
author:
...
description: This guide covers how to format community survey and biodiversity data to the "ecocomDP" harmonized data model. The ecocomDP standard and associated tools are a community-supported project involving the LTER Network, NEON, and others.
categories: draft

...
* **Review Threshold (250 GB):** To ensure optimal transfer speeds and manage system resources, we monitor large-volume uploads. If you plan to upload an individual entity **or** an entire data package that exceeds **250 GB**, please coordinate with us before initiating the process.

### How to Proceed with Large Uploads (250 GB+)

If your data exceeds the 250 GB threshold, please contact **support@edirepository.org** before beginning the upload. Please include:
...
Our team will work with you to help ensure the dataset is successfully ingested into the repository.

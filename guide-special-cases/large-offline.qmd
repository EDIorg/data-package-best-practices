...
* Data Entities
  * Offline Entity:
    * Describe as you would for an online resource. Restate the software needed to read the individual files if this is important to a user. See @tbl-1 and [Sample XML](#lst-xml-offline).
...
: Three required fields for an offline distribution {#tbl-1}
